...
urlpatterns = patterns('Empresas.views',
    ...
    url(r'^documento/nueva_version/(?:(?P<id>\w+))?$', 'nueva_version_documento', name='nueva_version_documento'),
    url(r'^documento/(?P<id>\w+)?$', 'mostrar_documento', name='mostrar_documento'),
    url(r'^documento/nuevo/formato/(?:(?P<proceso>\d+)?)(?:(\/)?(?P<id>\d+)?)$', 'nuevo_documento_by_formato', name='nuevo_documento_by_formato'),
    url(r'^documento/descargar_pdf/$', 'exportar_documento_pdf', name='exportar_documento_pdf'),
